...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://app.icecreamswap.com/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://app.icecreamswap.com/#/swap?inputCurrency=${
...
export function getMiningPoolLink(token0Address) {
  return `https://app.icecreamswap.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://app.icecreamswap.com/#/uni'
  if (!linkVariable) {
