...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://icecreamswap.com/swap?inputCurrency=${token0Address}`
  } else {
    return `https://icecreamswap.com/swap?inputCurrency=${token0Address === '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' ? 'ETH' : token0Address
      }&outputCurrency=${token1Address === '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' ? 'ETH' : token1Address}`
  }
}

export function getMiningPoolLink(token0Address) {
  return `https://icecreamswap.com/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://icecreamswap.com/uni'
  if (!linkVariable) {
...
export const urls = {
  showTransaction: (tx) => `https://brisescan.com/tx/${tx}/`,
  showAddress: (address) => `https://brisescan.com/address/${address}/`,
  showToken: (address) => `https://brisescan.com/token/${address}/`,
  showBlock: (block) => `https://brisescan.com/block/${block}/`,
}
